...
public class TestSuite_AddNewRiderPage extends BaseTestClass {
    ...
    @Test(groups = {TestGroup.SMOKE, TestGroup.SANITY, TestGroup.RIDERS}, description = "TC_045, Verify The UI Of New Rider Button")
    ...
    @Test(groups = {TestGroup.SMOKE,TestGroup.SANITY, TestGroup.RIDERS}, description = "TC_46, Verify The Functionality Of Breadcrumb Menu For Add New Rider Page")
    ...
    @Test(groups = {TestGroup.SMOKE,TestGroup.SANITY, TestGroup.RIDERS}, description = "TC_047, Verify The Validation Functionality For First Name In Add New Rider Page For Empty Field")
    ...
    @Test(groups = {TestGroup.SMOKE, TestGroup.SANITY, TestGroup.RIDERS}, description = "TC_048, Verify The Validation Functionality For First Name In Add New Rider Page For Minimum Character")
    ...
    @Test(groups = {TestGroup.SMOKE, TestGroup.SANITY, TestGroup.RIDERS}, description = "TC_049, Verify The Validation Functionality For First Name In Add New Rider Page For Maximum Character")
